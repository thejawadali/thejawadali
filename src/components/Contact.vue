...
<template>
  <div class="mt-32 lg:mx-32 relative flex flex-col items-end px-8 lg:px-0" id="about">
    <p data-aos="fade-down" class="text-primary text-5xl lg:text-7xl font-extralight w-full">
      You can
      <strong>Contact me</strong> via
    </p>
    <div class="w-full hidden md:inline-block">
      <div class="mt-10 w-full h-56 bg-footer" />
      <p
        class="ml-1 text-gray-500 text-xs max-w-lg tracking-wider my-5 hidden xl:inline-block"
      >{{ description }}</p>
    </div>
    <!-- contact form -->
    <div
      class="bg-secondary-light pl-10 pr-20 py-3 mx-auto my-5 md:m-0 md:relative md:bottom-24 xl:bottom-56 md:right-10 inline-block"
    >
      <div class="my-3">
